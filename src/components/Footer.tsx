            ...
            <div className="footer__inner">
                <div className="footer__top">
                    ...
                    <div>
                        ...
                        <ul className="footer__links">
                            {navLinks.map(l => (
                                <li key={l.id}>
                                    <span className="footer__link" onClick={() => onNavigate(l.id)}>
                                        {l.label}
                                    </span>
                                </li>
                            ))}
                    ...
                    <div>
                        ...
                        <div style={{ marginTop: '16px', padding: '12px 16px', background: 'rgba(104,220,227,0.1)', borderRadius: '10px', border: '1px solid rgba(104,220,227,0.2)' }}>
                            <div style={{ fontSize: '12px', color: 'rgba(255,255,255,0.6)', marginBottom: '4px' }}>Overseas Consultations</div>
                            <div style={{ fontSize: '13px', color: 'rgba(255,255,255,0.85)' }}>Sharjah & Doha — 1st Wed–Sat each month</div>
                        </div>
                    </div>
                </div>
                ...
                <div className="footer__bottom">
                    <div className="footer__copyright">
                        © {new Date().getFullYear()} Manassanthi Hospitals. All rights reserved.
                    </div>
                    <div className="footer__mhca">
                        Licensed under MHCA 2017
                    </div>
                </div>
            </div>
        </footer>
